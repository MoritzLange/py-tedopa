...
def _times_to_steps(times, num_trotter_slices):
    ...
    Args:
        times (list of float): The times for which the evolution should be computed
...
def _get_h_list(hs, num_sites):
    ...
    Returns:
         list: A list of Hamiltonians acting on the single sites, like [h1, h2, h3, ...]
         list: A list of Hamiltonians acting on each two adjacent sites, like [h12, h23, h34, ...]
...
def _get_u_list(h_single, h_adjacent, tau):
    ...
    Returns:
        ...
        list: List of operators acting on odd adjacent sites, like [u12, u34, ...]
        list: List of operators acting on even adjacent sites, like [u23, u45, ...]
    """
...
def _u_list_to_mpo(dims, u_odd, u_even):
    ...
    Returns:
        ...
        mpnum.MPArray: The time evolution MPOs for the full state acting on even adjacent sites
    """
